...
abstract class OnlineSource(context: Context) : Source {
     ...
     * Network service.
     */
    val network: NetworkHelper = DIReplacement.get().injectNetworkHelper()

    /**
     * Chapter cache.
     */
    val chapterCache: ChapterCache = DIReplacement.get().injectChapterCache()

    /**
     * Preferences helper.
     */
    val preferences: PreferencesHelper = DIReplacement.get().injectPreferencesHelper()
