...
public class Intent implements Parcelable, Cloneable {
    ...
    public static class ShortcutIconResource implements Parcelable {
         ...
         */
        public static final Parcelable.Creator<ShortcutIconResource> CREATOR = null;
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_HEADSET_PLUG = null;
    ...
    /** @hide */
    @IntDef(flag = true, value = { FLAG_GRANT_READ_URI_PERMISSION, FLAG_GRANT_WRITE_URI_PERMISSION, FLAG_GRANT_PERSISTABLE_URI_PERMISSION, FLAG_GRANT_PREFIX_URI_PERMISSION })
    @Retention(RetentionPolicy.SOURCE)
    public @interface GrantUriMode {
    }

    /** @hide */
    @IntDef(flag = true, value = { FLAG_GRANT_READ_URI_PERMISSION, FLAG_GRANT_WRITE_URI_PERMISSION })
    @Retention(RetentionPolicy.SOURCE)
     ...
     */
    public static final int IMMUTABLE_FLAGS = 0;
    ...
    /** @hide */
    @IntDef(flag = true, value = { FILL_IN_ACTION, FILL_IN_DATA, FILL_IN_CATEGORIES, FILL_IN_COMPONENT, FILL_IN_PACKAGE, FILL_IN_SOURCE_BOUNDS, FILL_IN_SELECTOR, FILL_IN_CLIP_DATA })
    @Retention(RetentionPolicy.SOURCE)
    ...
    public static final Parcelable.Creator<Intent> CREATOR = null;
